...
public class T08_equals_hashcodeTest {
	 ...
	 * HashSet, HashMap, Hashtable에서는 객체가 같은지 여부를 데이터 추가할 때 검사한다.
	 * 
	 ...
	 * 
	 * hashCode()메서드에서 사용하는 '해싱 알고리즘'에서 서로 다른 객체에 대하여  hashCode값을 만들어 낼 수 있다.
	 * 그래서 객체가 같지 않더라도 hashCode가 같을 수 있다.
	 * 
	 * hashCode로 비교해서 true값이 나왔을 지라도 equals로 다시 한번 비교한다.
	 */
	...
	public static void main(String[] args) {
		...
		System.out.println("p3 add 성공 여부 : " + set.add(p3));
