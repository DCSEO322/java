...
public class T01_StackQueueTest {
	/**
	 * Stack => 후입선출(LIFO)와 자료구조
	 * Queue => 선입선출(FIFO)와 자료구조
	 * 
	...
	public static void main(String[] args) {
		...
		System.out.println("stack에서 꺼내온 자료 : " + data);
		System.out.println("stack에서 꺼내온 자료 : " + stack.pop());
		System.out.println("현재 stack의 값들 : " + stack);
		 ...
		 * Queue 명령
		 * 1) 자료 입력 : offer(저장할 값)
		 * 2) 자료 출력 : poll() => 자료를 Queue에서 꺼내온 후 꺼내온 자료는 Queue에서 삭제
		 */
