...
public class T12_PropertiesTest {
	 ...
	 * Map은 모든 형태의 객체 데이터를 key와 value값으로 사용할 수 있다.
	 * Properties는 key와 value값으로 String만 사용할 수 있다.
	 * 
	 * Map은 put(), get()메서드를 이용해서 데이터를 입출력한다.
	...
	public static void main(String[] args) throws FileNotFoundException, IOException {
		...
		// 내용 파일로 저장하기
		prop.store(new FileOutputStream("src/kr/or/ddit/basic/test.properties"), "this is comments");
